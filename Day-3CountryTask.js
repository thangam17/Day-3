Question How to compare two JSON have the same properties without order? a.let obj1 = { name: "person1", age: 5}; b.let obj2 = { age:5, name: "person1"};
...
Question use the rest countries' API URL -> https://restcountries.com/v3.1/all and display all the country flags in the console
...
Question Use the same rset countries and print all countries names, regions, sub-regions and populations
